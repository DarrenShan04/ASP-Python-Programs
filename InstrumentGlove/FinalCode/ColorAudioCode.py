...
if re in range(15, 41) and gr in range(40, 66) and bl in range(20, 51) and cl in range(100, 126) and lux in range(50, 76):
    #os.system(namesForInstrument[BGgreen])
...
elif re in range(15, 41) and gr in range(65, 91) and bl in range(80, 106) and cl in range(190, 216) and lux in range(50, 76):
    #os.system(namesForInstrument[BGblue])
    for key in dictionary:
        if inssensedcolor[0] in dictionary[key][0] and inssensedcolor[1] in dictionary[key][1] and inssensedcolor[2] in dictionary[key][2] and inssensedcolor[3] in dictionary[key][3] and lux in dictionary[key][4]:
            os.system(pianoTunes[key])
elif re in range(60, 86) and gr in range(80, 106) and bl in range(100, 126) and cl in range(240, 261) and lux in range(40, 66):
    #os.system(namesForInstrument[BGlavender])
    for key in dictionary:
        if inssensedcolor[0] in dictionary[key][0] and inssensedcolor[1] in dictionary[key][1] and inssensedcolor[2] in dictionary[key][2] and inssensedcolor[3] in dictionary[key][3] and lux in dictionary[key][4]:
